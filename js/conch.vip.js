var Conch = {
	...
	'Swiper': {
        'Init': function() {
            $.getScript("//static-cdn.anfuns.cn/conch_tpl/js/set/swiper.min.js", function() {
    ...
    'Search': {
        ...
        'Suggest':function($obj,$mid){
            $.getScript("//static-cdn.anfuns.cn/conch_tpl/js/set/autocomplete.js",function(){
    ...
    'Other':{
        ...
        'Color': function() {
			...
			$(".hl-color-item a").click(function(){
                ...
                $("link[name='color']").attr("href","//static-cdn.anfuns.cn/conch_tpl/css/"+$Color+".css?v="+conchtpl.ver+"");  
